          ...
          <div className="sticky top-20">
            ...
            <div className="space-y-4">
              ...
              {resumeData.personalInfo.phone && (
                <div className="flex items-center gap-2">
                  <a href={`tel:${resumeData.personalInfo.phone}`} className="text-primary hover:underline">
                    {resumeData.personalInfo.phone}
                  </a>
                </div>
              )}
              ...
              {resumeData.personalInfo.codeforces && (
                <div className="flex items-center gap-2">
                  <Link href={resumeData.personalInfo.codeforces} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                    Codeforces
                  </Link>
                </div>
              )}
              {resumeData.personalInfo.upwork && (
                <div className="flex items-center gap-2">
                  <Link href={resumeData.personalInfo.upwork} target="_blank" rel="noopener noreferrer" className="text-primary hover:underline">
                    Upwork
                  </Link>
                </div>
              )}
